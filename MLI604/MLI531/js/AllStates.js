...
GameStateHandler._Screen = function() {
  var button_back, text_back, game_description, game_controls;
};
GameStateHandler._Screen.prototype = {
    create: function() {
      var Menu_backGround = this.add.image(0,0, 'Menu_Background');
      Menu_backGround.alpha = 0.35;
      ...
      var controlstext = game.add.bitmapText(50, 350, 'font_game', game_controls, 20,);
...
GameStateHandler.Play.prototype = {
  ...
  if(enterKey.justPressed() && isTouching == true) {
...
GameStateHandler.GameOver.prototype = {
  ...
  game.state.add('Options_Screen', GameStateHandler._Screen);
