...
GameState.prototype.preload = function() {
    this.game.load.image("block", "assets/furniture2.png");
    this.load.spritesheet('person', 'baddie.png', 32,32);
};
// Setup the example
GameState.prototype.create = function() {
    ...
    // Add the ball
    this.ball = this.game.add.sprite(this.game.width/2, this.game.height/2, 'person');
    ball.frame = 3;
